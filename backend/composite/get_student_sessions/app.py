...
api = Api(app, doc="/docs",
    title="Get Student Sessions Service",
    version="1.0",
    description="Composite service to retrieve student sessions with tutor details and pricing"
)
...
class Health(Resource):
    def get(self):
        return {"status": "healthy", "service": "get_student_sessions"}, 200
